...
const ListComponent = () => {
  ...
  return (
    <div className="border-2 border-blue-100 mt-10 mr-2 ml-2">
      <h1 className="text-center p-1"> 제품 목록 콤포넌트</h1>
        ...
        {serverData.dtoList.map((i) => (
          ...
          >
            <div className="flex flex-col h-full">
              <div className="font-extralight text-2xl p-2 w-full">{i.pno}</div>
              <div className="text-2x1 m-1 p-2 w-full flex flex-col">
                ...
                <div className="bottom-0 font-extrabold bg-white">
                  <div className="text-center p-1">상품 설명 : {i.pdesc}</div>
                </div>
                <div className="bottom-0 font-extrabold bg-white">
